...
class INPUTred extends Component {
  constructor(props){
    super(props);
          ...
          <View style={styles.content}>
              ...
              <View style={styles.part1_1}>
                ...
                <View style={styles.part1_1_2}>
                  <TouchableHighlight onPress={ () => {
                      ...
                      xmlHttp.send(JSON.stringify({name: this.state.NameDone, triage:1, gender:this.state.GenderDone, age:this.state.AgeDone, hospital:this.state.HospitalDone, breath:this.state.BreathDone, heart:this.state.BPM, blood:this.state.BloodDone}));
            ...
            <View style={styles.part2}>
              <View style={styles.part2_X}>
                <Image source={require('./drawable-mdpi/ic_1_breath.png')} style={styles.part2_X_img}></Image>  
              ...
              <View style={{borderRightColor:'white', borderLeftColor:'white', borderLeftWidth:0.2, borderRightWidth:0.2, justifyContent: 'center', alignItems: 'center', flex:1,}}>
                <Image source={require('./drawable-mdpi/ic_1_heart.png')} style={styles.part2_X_img}></Image>
                <Text style={{fontSize:30, color:'white', fontWeight:'bold'}}>{this.state.BPM}</Text>
                <Text style={{color:'white'}}>times/min</Text>
              </View>
              
              <View style={styles.part2_X}>
                <Image source={require('./drawable-mdpi/ic_1_blood.png')} style={styles.part2_X_img}></Image>
