...
class INPUTgreen extends Component {
  constructor(props){
    super(props);
          ...
          <View style={styles.content}>
            ...
            <View style={styles.part1}>
                ...
                <View style={styles.part1_1_2}>
                  <TouchableHighlight onPress={ () => {
                      ...
                      xmlHttp.onreadystatechange = (e) => {
                        ...
                        if (xmlHttp.status === 200) {
                          console.log('success', xmlHttp.responseText);
                          console.log(this.state.NameDone)
                        } else {
                          console.warn('error');
                        }
                      };
                      ...
                      xmlHttp.send(JSON.stringify({name: this.state.NameDone, triage:3, gender:this.state.GenderDone, age:this.state.AgeDone, hospital:this.state.HospitalDone, breath:this.state.BreathDone, heart:this.state.BPM, blood:this.state.BloodDone}));
              ...
              <View style={styles.part1_2}>
                <Image source={require('./drawable-mdpi/1.png')} style={{height:320,width:90}} />
            ...
            <View style={styles.part2}>
              <View style={styles.part2_X}>
                <Image source={require('./drawable-mdpi/ic_3_breath.png')} style={styles.part2_X_img}></Image>
              ...
              <View style={{borderRightColor:'white', borderLeftColor:'white', borderLeftWidth:0.2, borderRightWidth:0.2, justifyContent: 'center', alignItems: 'center', flex:1,}}>
                <Image source={require('./drawable-mdpi/ic_3_heart.png')} style={styles.part2_X_img}></Image>
                <Text style={{fontSize:30, color:'white', fontWeight:'bold'}}>{this.state.BPM}</Text>
                <Text style={{color:'white'}}>times/min</Text>
              </View>
              
              <View style={styles.part2_X}>
                <Image source={require('./drawable-mdpi/ic_3_blood.png')} style={styles.part2_X_img}></Image>
